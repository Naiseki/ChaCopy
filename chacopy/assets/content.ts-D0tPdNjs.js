(function(){function K(e){const t=e.cloneNode(!0);return X(t),J(t),Q(t),t}function X(e){var r,i;const t=Array.from(e.querySelectorAll("pre")),n=e.ownerDocument??document;for(const o of t){const s=o.querySelector("div.flex.items-center.text-token-text-primary"),l=((r=s==null?void 0:s.textContent)==null?void 0:r.trim())??"",a=o.querySelector(".cm-content");if(!a)continue;const c=a.cloneNode(!0),f=c.querySelectorAll(".cm-line");if(f.length>0)for(const m of Array.from(f))(i=m.textContent)!=null&&i.endsWith(`
`)||m.appendChild(n.createTextNode(`
`));else{const m=c.querySelectorAll("br");for(const G of Array.from(m))G.replaceWith(`
`)}const d=n.createElement("pre"),h=n.createElement("code");l&&(h.className=`language-${l}`),h.textContent=c.textContent,d.appendChild(h),o.replaceWith(d)}}function J(e){var r,i;const t=Array.from(e.querySelectorAll("span.katex-display"));for(const o of t){const s=o.querySelector('annotation[encoding="application/x-tex"]');if(!s)continue;const l=((r=s.textContent)==null?void 0:r.trim())??"",a=R(`

$$${l}$$

`,e);o.replaceWith(a)}const n=Array.from(e.querySelectorAll("span.katex"));for(const o of n){const s=o.querySelector('annotation[encoding="application/x-tex"]');if(!s)continue;const l=((i=s.textContent)==null?void 0:i.trim())??"",a=R(`$${l}$`,e);o.replaceWith(a)}}function R(e,t){const r=(t.ownerDocument??document).createElement("span");return r.setAttribute("data-chacopy-math","true"),r.textContent=e,r}function Q(e){for(const t of e.querySelectorAll("[data-footnotes], .citation, sup"))t.remove()}function Z(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)n.hasOwnProperty(r)&&(e[r]=n[r])}return e}function b(e,t){return Array(t+1).join(e)}function P(e){return e.replace(/^\n*/,"")}function I(e){for(var t=e.length;t>0&&e[t-1]===`
`;)t--;return e.substring(0,t)}function $(e){return I(P(e))}var ee=["ADDRESS","ARTICLE","ASIDE","AUDIO","BLOCKQUOTE","BODY","CANVAS","CENTER","DD","DIR","DIV","DL","DT","FIELDSET","FIGCAPTION","FIGURE","FOOTER","FORM","FRAMESET","H1","H2","H3","H4","H5","H6","HEADER","HGROUP","HR","HTML","ISINDEX","LI","MAIN","MENU","NAV","NOFRAMES","NOSCRIPT","OL","OUTPUT","P","PRE","SECTION","TABLE","TBODY","TD","TFOOT","TH","THEAD","TR","UL"];function A(e){return T(e,ee)}var H=["AREA","BASE","BR","COL","COMMAND","EMBED","HR","IMG","INPUT","KEYGEN","LINK","META","PARAM","SOURCE","TRACK","WBR"];function _(e){return T(e,H)}function te(e){return q(e,H)}var F=["A","TABLE","THEAD","TBODY","TFOOT","TH","TD","IFRAME","SCRIPT","AUDIO","VIDEO"];function ne(e){return T(e,F)}function re(e){return q(e,F)}function T(e,t){return t.indexOf(e.nodeName)>=0}function q(e,t){return e.getElementsByTagName&&t.some(function(n){return e.getElementsByTagName(n).length})}var u={};u.paragraph={filter:"p",replacement:function(e){return`
...
`}};u.listItem={filter:"li",replacement:function(e,t,n){var r=n.bulletListMarker+"   ",i=t.parentNode;if(i.nodeName==="OL"){var o=i.getAttribute("start"),s=Array.prototype.indexOf.call(i.children,t);r=(o?Number(o)+s:s+1)+".  "}var l=/\n$/.test(e);return e=$(e)+(l?`
`:""),e=e.replace(/\n/gm,`
...
`}};u.fencedCodeBlock={filter:function(e,t){return t.codeBlockStyle==="fenced"&&e.nodeName==="PRE"&&e.firstChild&&e.firstChild.nodeName==="CODE"},replacement:function(e,t,n){for(var r=t.firstChild.getAttribute("class")||"",i=(r.match(/language-(\S+)/)||[null,""])[1],o=t.firstChild.textContent,s=n.fence.charAt(0),l=3,a=new RegExp("^"+s+"{3,}","gm"),c;c=a.exec(o);)c[0].length>=l&&(l=c[0].length+1);var f=b(s,l);return`
...
`}};u.inlineLink={filter:function(e,t){return t.linkStyle==="inlined"&&e.nodeName==="A"&&e.getAttribute("href")},replacement:function(e,t){var n=t.getAttribute("href");n&&(n=n.replace(/([()])/g,"\\$1"));var r=g(t.getAttribute("title"));return r&&(r=' "'+r.replace(/"/g,'\\"')+'"'),"["+e+"]("+n+r+")"}};u.referenceLink={filter:function(e,t){return t.linkStyle==="referenced"&&e.nodeName==="A"&&e.getAttribute("href")},replacement:function(e,t,n){var r=t.getAttribute("href"),i=g(t.getAttribute("title"));i&&(i=' "'+i+'"');var o,s;switch(n.linkReferenceStyle){case"collapsed":o="["+e+"][]",s="["+e+"]: "+r+i;break;case"shortcut":o="["+e+"]",s="["+e+"]: "+r+i;break;default:var l=this.references.length+1;o="["+e+"]["+l+"]",s="["+l+"]: "+r+i}return this.references.push(s),o},references:[],append:function(e){var t="";return this.references.length&&(t=`
...
`):""}function W(e){this.options=e,this._keep=[],this._remove=[],this.blankRule={replacement:e.blankReplacement},this.keepReplacement=e.keepReplacement,this.defaultRule={replacement:e.defaultReplacement},this.array=[];for(var t in e.rules)this.array.push(e.rules[t])}W.prototype={add:function(e,t){this.array.unshift(t)},keep:function(e){this._keep.unshift({filter:e,replacement:this.keepReplacement})},remove:function(e){this._remove.unshift({filter:e,replacement:function(){return""}})},forNode:function(e){if(e.isBlank)return this.blankRule;var t;return(t=y(this.array,e,this.options))||(t=y(this._keep,e,this.options))||(t=y(this._remove,e,this.options))?t:this.defaultRule},forEach:function(e){for(var t=0;t<this.array.length;t++)e(this.array[t],t)}};function y(e,t,n){for(var r=0;r<e.length;r++){var i=e[r];if(ie(i,t,n))return i}}function ie(e,t,n){var r=e.filter;if(typeof r=="string"){if(r===t.nodeName.toLowerCase())return!0}else if(Array.isArray(r)){if(r.indexOf(t.nodeName.toLowerCase())>-1)return!0}else if(typeof r=="function"){if(r.call(e,t,n))return!0}else throw new TypeError("`filter` needs to be a string, array, or function")}function oe(e){var t=e.element,n=e.isBlock,r=e.isVoid,i=e.isPre||function(d){return d.nodeName==="PRE"};if(!(!t.firstChild||i(t))){for(var o=null,s=!1,l=null,a=w(l,t,i);a!==t;){if(a.nodeType===3||a.nodeType===4){var c=a.data.replace(/[ \r\n\t]+/g," ");if((!o||/ $/.test(o.data))&&!s&&c[0]===" "&&(c=c.substr(1)),!c){a=C(a);continue}a.data=c,o=a}else if(a.nodeType===1)n(a)||a.nodeName==="BR"?(o&&(o.data=o.data.replace(/ $/,"")),o=null,s=!1):r(a)||i(a)?(o=null,s=!0):o&&(s=!1);else{a=C(a);continue}var f=w(l,a,i);l=a,a=f}o&&(o.data=o.data.replace(/ $/,""),o.data||C(o))}}function C(e){var t=e.nextSibling||e.parentNode;return e.parentNode.removeChild(e),t}function w(e,t,n){return e&&e.parentNode===t||n(t)?t.nextSibling||t.parentNode:t.firstChild||t.nextSibling||t.parentNode}var k=typeof window<"u"?window:{};function ae(){var e=k.DOMParser,t=!1;try{new e().parseFromString("","text/html")&&(t=!0)}catch{}return t}function se(){var e=function(){};return le()?e.prototype.parseFromString=function(t){var n=new window.ActiveXObject("htmlfile");return n.designMode="on",n.open(),n.write(t),n.close(),n}:e.prototype.parseFromString=function(t){var n=document.implementation.createHTMLDocument("");return n.open(),n.write(t),n.close(),n},e}function le(){var e=!1;try{document.implementation.createHTMLDocument("").open()}catch{k.ActiveXObject&&(e=!0)}return e}var ce=ae()?k.DOMParser:se();function ue(e,t){var n;if(typeof e=="string"){var r=fe().parseFromString('<x-turndown id="turndown-root">'+e+"</x-turndown>","text/html");n=r.getElementById("turndown-root")}else n=e.cloneNode(!0);return oe({element:n,isBlock:A,isVoid:_,isPre:t.preformattedCode?de:null}),n}var N;function fe(){return N=N||new ce,N}function de(e){return e.nodeName==="PRE"||e.nodeName==="CODE"}function he(e,t){return e.isBlock=A(e),e.isCode=e.nodeName==="CODE"||e.parentNode.isCode,e.isBlank=pe(e),e.flankingWhitespace=me(e,t),e}function pe(e){return!_(e)&&!ne(e)&&/^\s*$/i.test(e.textContent)&&!te(e)&&!re(e)}function me(e,t){if(e.isBlock||t.preformattedCode&&e.isCode)return{leading:"",trailing:""};var n=ge(e.textContent);return n.leadingAscii&&O("left",e,t)&&(n.leading=n.leadingNonAscii),n.trailingAscii&&O("right",e,t)&&(n.trailing=n.trailingNonAscii),{leading:n.leading,trailing:n.trailing}}function ge(e){var t=e.match(/^(([ \t\r\n]*)(\s*))(?:(?=\S)[\s\S]*\S)?((\s*?)([ \t\r\n]*))$/);return{leading:t[1],leadingAscii:t[2],leadingNonAscii:t[3],trailing:t[4],trailingNonAscii:t[5],trailingAscii:t[6]}}function O(e,t,n){var r,i,o;return e==="left"?(r=t.previousSibling,i=/ $/):(r=t.nextSibling,i=/^ /),r&&(r.nodeType===3?o=i.test(r.nodeValue):n.preformattedCode&&r.nodeName==="CODE"?o=!1:r.nodeType===1&&!A(r)&&(o=i.test(r.textContent))),o}var ve=Array.prototype.reduce,ye=[[/\\/g,"\\\\"],[/\*/g,"\\*"],[/^-/g,"\\-"],[/^\+ /g,"\\+ "],[/^(=+)/g,"\\$1"],[/^(#{1,6}) /g,"\\$1 "],[/`/g,"\\`"],[/^~~~/g,"\\~~~"],[/\[/g,"\\["],[/\]/g,"\\]"],[/^>/g,"\\>"],[/_/g,"\\_"],[/^(\d+)\. /g,"$1\\. "]];function v(e){if(!(this instanceof v))return new v(e);var t={rules:u,headingStyle:"setext",hr:"* * *",bulletListMarker:"*",codeBlockStyle:"indented",fence:"```",emDelimiter:"_",strongDelimiter:"**",linkStyle:"inlined",linkReferenceStyle:"full",br:"  ",preformattedCode:!1,blankReplacement:function(n,r){return r.isBlock?`
...
`)&&e.startsWith("$$",n)){n>r&&t.push({text:e.slice(r,n),protected:!1});const i=e.indexOf("$$",n+2),o=i===-1?e.length:i+2;t.push({text:e.slice(n,o),protected:!0}),n=o,r=n;continue}if(e[n]==="`"&&e[n+1]!=="`"){n>r&&t.push({text:e.slice(r,n),protected:!1});const i=e.indexOf("`",n+1),o=i===-1?e.length:i+1;t.push({text:e.slice(n,o),protected:!0}),n=o,r=n;continue}if(e[n]==="$"&&e[n+1]!=="$"){n>r&&t.push({text:e.slice(r,n),protected:!1});const i=e.indexOf("$",n+1),o=i===-1?e.length:i+1;t.push({text:e.slice(n,o),protected:!0}),n=o,r=n;continue}n++}return r<e.length&&t.push({text:e.slice(r),protected:!1}),t}function Me(e){const t=K(e),r=Oe().turndown(t);return Be(r)}const L="data-chacopy-injected",Pe='[data-testid="copy-turn-action-button"]',z=".markdown.prose",Ie='[data-message-author-role="assistant"]',D='[class="touch:-me-2 touch:-ms-3.5 -ms-2.5 -me-1 flex flex-wrap items-center gap-y-4 p-1 select-none touch:w-[calc(100%+--spacing(3.5))] -mt-1 w-[calc(100%+--spacing(2.5))] duration-[1.5s] focus-within:transition-none hover:transition-none touch:pointer-events-auto pointer-events-none [mask-image:linear-gradient(to_right,black_33%,transparent_66%)] [mask-size:300%_100%] [mask-position:100%_0%] motion-safe:transition-[mask-position] group-hover/turn-messages:pointer-events-auto group-hover/turn-messages:[mask-position:0_0] group-focus-within/turn-messages:pointer-events-auto group-focus-within/turn-messages:[mask-position:0_0] has-data-[state=open]:pointer-events-auto has-data-[state=open]:[mask-position:0_0]"], [aria-label="Response actions"], [aria-label="回答のアクション"], [aria-label="応答アクション"]';function $e(){const e=document.querySelectorAll(Pe);for(const t of e)x(t)}function x(e){var n;if((n=e.parentElement)!=null&&n.querySelector('[data-chacopy-button="true"]')||!Y(e))return!1;const t=He(e);return e.insertAdjacentElement("afterend",t),!0}function He(e){const t=document.createElement("button");t.setAttribute("aria-label","Copy as Markdown"),t.setAttribute("title","Copy as Markdown (ChaCopy)"),t.setAttribute("data-chacopy-button","true"),t.style.cssText=`
        font-size: 12px;
        font-weight: 600;
        padding: 6px 10px;
        cursor: pointer;
        ...
        position: relative;
        opacity: 0.8;
    `;const n=document.createElement("img");n.src=chrome.runtime.getURL("img/chacopy_icon48.png"),n.alt="Copy",n.style.cssText="width: 19px; height: 19px; object-fit: contain;",t.appendChild(n);const r=t.innerHTML;return t.addEventListener("mouseenter",()=>{t.style.backgroundColor="var(--hover-bg, rgba(0, 0, 0, 0.05))",t.style.borderColor="var(--hover-border, rgba(0, 0, 0, 0.08))",t.style.opacity="1"}),t.addEventListener("mouseleave",()=>{t.style.backgroundColor="transparent",t.style.borderColor="transparent",t.style.opacity="0.8"}),t.addEventListener("mousedown",()=>{t.style.transform="scale(0.95)"}),t.addEventListener("mouseup",()=>{t.style.transform="scale(1)"}),t.addEventListener("click",()=>void _e(e,t,r)),t}async function _e(e,t,n){const r=Y(e);if(!r){console.warn("[ChaCopy] Message root not found");return}r.hasAttribute(L)||r.setAttribute(L,"true");const i=r.querySelector(z);if(!i){console.warn("[ChaCopy]  Message element not found");return}const o=Me(i);try{await navigator.clipboard.writeText(o),t.innerHTML="",t.style.color="#00ff7f",t.textContent="Copied!",setTimeout(()=>{t.innerHTML=n},1500)}catch(s){const l=s instanceof Error?s.message:String(s);console.error("[ChaCopy] Failed to write to clipboard:",l),t.innerHTML="",t.style.color="#ff4500",t.textContent="ERROR",setTimeout(()=>{t.innerHTML=n},1500)}}function Y(e){const t=e.closest(D);if(!t)return null;let n=t.parentElement;for(;n;){if(n.querySelector(Ie)&&n.querySelector(z)&&n.querySelector(D))return n;n=n.parentElement}return null}const M='[data-testid="copy-turn-action-button"]';function Fe(){const e=document.querySelector("main")??document.body;new MutationObserver(n=>{for(const r of n)for(const i of r.addedNodes)if(i instanceof HTMLElement){i.matches(M)&&x(i);for(const o of i.querySelectorAll(M))x(o)}}).observe(e,{childList:!0,subtree:!0})}$e();Fe();
})()
